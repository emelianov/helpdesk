...
$acl		= array();
//$acl[]		= array(64, 'Emelianov_AM', true);
...
//   $user->vizaEdit = $vizaEdit;
  ...
  $tpl->parse('TABLE_TEXT', 'wt_header');
   $user->tplTableInner('TABLE_TEXT', 
	...
	array('fio', 'tabel', false, false, false, false, false), 
	array('mailto:', '?date='.date('d-m-Y',$start).'&interval='.$int.'&tab=', false, false, false, false, false),
